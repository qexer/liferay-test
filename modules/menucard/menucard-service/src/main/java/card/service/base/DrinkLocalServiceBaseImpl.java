 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link card.service.impl.DrinkLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see card.service.impl.DrinkLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class DrinkLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DrinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>card.service.DrinkLocalServiceUtil</code>.
	 */
	...
	public Drink fetchDrinkByUuidAndGroupId(String uuid, long groupId) {
		return drinkPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Drink>() {
				...
				@Override
				public void performAction(Drink drink) throws PortalException {
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, drink);
				}
	...
	public List<Drink> getDrinksByUuidAndCompanyId(
		...
		return drinkPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Drink> getDrinksByUuidAndCompanyId(
		...
		return drinkPersistence.findByUuid_C(
	...
	public Drink getDrinkByUuidAndGroupId(String uuid, long groupId)
		...
		return drinkPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"card.model.Drink", drinkLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("card.model.Drink");
	}
