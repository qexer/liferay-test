...
public interface DrinkLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DrinkLocalServiceUtil} to access the drink local service. Add custom service methods to <code>menu.service.impl.DrinkLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
