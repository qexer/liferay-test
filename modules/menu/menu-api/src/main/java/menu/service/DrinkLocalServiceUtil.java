 ...
 * <code>menu.service.impl.DrinkLocalServiceImpl</code> and
...
public class DrinkLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>menu.service.impl.DrinkLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static menu.model.Drink addDrink(menu.model.Drink drink) {
	 ...
	 */
	public static menu.model.Drink createDrink(long drinkId) {
	 ...
	 */
	public static menu.model.Drink deleteDrink(menu.model.Drink drink) {
	 ...
	 */
	public static menu.model.Drink deleteDrink(long drinkId)
	...
	public static menu.model.Drink fetchDrink(long drinkId) {
	 ...
	 * @throws PortalException if a drink with the primary key could not be found
	 */
	public static menu.model.Drink getDrink(long drinkId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<menu.model.Drink> getDrinks(
		int start, int end) {
	 ...
	 */
	public static menu.model.Drink updateDrink(menu.model.Drink drink) {
