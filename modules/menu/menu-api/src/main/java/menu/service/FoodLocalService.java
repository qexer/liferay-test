...
public interface FoodLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FoodLocalServiceUtil} to access the food local service. Add custom service methods to <code>menu.service.impl.FoodLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
