...
import menu.service.DrinkService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link menu.service.impl.DrinkServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see menu.service.impl.DrinkServiceImpl
 * @generated
 */
public abstract class DrinkServiceBaseImpl
	extends BaseServiceImpl implements DrinkService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DrinkService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>menu.service.DrinkServiceUtil</code>.
	 */
	 ...
	 */
	public menu.service.DrinkLocalService getDrinkLocalService() {
	 ...
	 */
	public void setDrinkLocalService(
		menu.service.DrinkLocalService drinkLocalService) {

		this.drinkLocalService = drinkLocalService;
	}

	/**
	 * Returns the drink remote service.
	 *
	 * @return the drink remote service
	 */
	...
	/**
	 * Sets the drink remote service.
	 *
	 * @param drinkService the drink remote service
	 */
	...
	/**
	 * Returns the food remote service.
	 *
	 * @return the food remote service
	 */
	public menu.service.FoodService getFoodService() {
		return foodService;
	}

	/**
	 * Sets the food remote service.
	 *
	 * @param foodService the food remote service
	 */
	public void setFoodService(menu.service.FoodService foodService) {
	...
	@BeanReference(type = menu.service.DrinkLocalService.class)
	protected menu.service.DrinkLocalService drinkLocalService;

	@BeanReference(type = DrinkService.class)
	...
	@BeanReference(type = menu.service.FoodService.class)
	protected menu.service.FoodService foodService;
