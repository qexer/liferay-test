 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link menu.service.impl.FoodServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see menu.service.impl.FoodServiceImpl
 * @generated
 */
public abstract class FoodServiceBaseImpl
	extends BaseServiceImpl implements FoodService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FoodService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>menu.service.FoodServiceUtil</code>.
	 */
	 ...
	 */
	public menu.service.DrinkService getDrinkService() {
		return drinkService;
	}
	 ...
	 */
	public void setDrinkService(menu.service.DrinkService drinkService) {
	...
	@BeanReference(type = menu.service.DrinkService.class)
	protected menu.service.DrinkService drinkService;
	...
	@BeanReference(type = FoodService.class)
